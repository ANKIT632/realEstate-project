...
function TopNavBar() {
  ...
  return (
    ...
    <nav className="w-full sticky top-0 h-12 bg-sky-900 z-50">
      <h1 className="text-white p-[3px] pt-2 font-serif font-extrabold text-[22px] ml-2 cursor-pointer" onClick={() => navigate('./')}>Estate-Ease</h1>
