...
function HomeCategory() {
  ...
  <div className='h-16  bg-white absolute bottom-[35%] z-50 flex items-center rounded-lg left-2 opacity-60 cursor-pointer hover:opacity-90 border border-blue-500 ' onClick={previous}>
  <img src={leftArrow} alt='left' className='h-5 w-4  opcity-100' />  
</div>

<div className='h-16  bg-white absolute bottom-[35%] z-50 flex items-center rounded-lg right-2 opacity-60 cursor-pointer hover:opacity-90 border border-blue-500 ' onClick={next}>
